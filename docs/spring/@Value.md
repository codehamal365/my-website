...
![图片](assets/202203191639539.png)那么，如何解决乱码问题呢？
...
好吧，那我在:号后加null，总可以了吧？![图片](assets/202203191640025.png)Set集合也不是空的，而是包含了一个"null"字符串的集合。
...
运行之后，结果对了：![图片](assets/202203191640790.png)
